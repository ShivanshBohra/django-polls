...
def vote(request: HttpRequest, question_id: int) -> HttpResponse:
    ...
    try:
        ...
        logger.error("Vote error: User didn't select a choice for question ID %s", question_id)
        return render(
            request,
            "polls/detail.html",
        ...
        # Log a successful vote
        logger.info("Vote recorded for choice %s for question ID %s", selected_choice.id, question_id)
...
# Detail view:we ant to simply display a model.
# List view: we want to simply display the list of the model.
